...
${OBJECTDIR}/_ext/b8fdb47f/fundamental_object.o: ../../src/objects/fundamental/fundamental_object.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../../src -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/b8fdb47f/fundamental_object.o ../../src/objects/fundamental/fundamental_object.cpp

${OBJECTDIR}/_ext/b8fdb47f/parallelogram.o: ../../src/objects/fundamental/parallelogram.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/b8fdb47f
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../../src -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/b8fdb47f/parallelogram.o ../../src/objects/fundamental/parallelogram.cpp

${OBJECTDIR}/_ext/b8fdb47f/sphere.o: ../../src/objects/fundamental/sphere.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/b8fdb47f
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../../src -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/b8fdb47f/sphere.o ../../src/objects/fundamental/sphere.cpp

${OBJECTDIR}/_ext/b8fdb47f/triangle.o: ../../src/objects/fundamental/triangle.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/b8fdb47f
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../../src -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/b8fdb47f/triangle.o ../../src/objects/fundamental/triangle.cpp
...
${OBJECTDIR}/_ext/1259a249/scene.o: ../../src/objects/scene.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/1259a249
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../../src -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1259a249/scene.o ../../src/objects/scene.cpp
